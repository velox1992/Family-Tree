...
var familyRelations = require("./familyRelations.json");
...
class App extends React.Component {
  ...
  render() {
    ...
    let hFamilyRelationStructure

    return (
      <div className="App">
        <h1>Familienstammbaum</h1>
        <FamilyGraph />
        {/*<JsonEditor value={this.state.familyRelationStructure} onChange={this.JsonValueChanged} />*/}
      </div>
    );
  }
}
